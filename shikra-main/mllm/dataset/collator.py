...
def get_collator(name, tokenizer=None, model=None, preprocessor=None):
    if name == "Seq2Seq2DataCollatorWithImage":
        return Seq2Seq2DataCollatorWithImage(tokenizer, model, preprocessor)
    else:
