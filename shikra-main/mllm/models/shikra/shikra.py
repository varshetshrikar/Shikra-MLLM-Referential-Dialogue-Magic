...
class ShikraLlamaModel(LlamaModel):
    ...
    def initialize_vision_modules(self, vision_tower, mm_vision_select_layer,
        ...
        if pretrain_mm_mlp_adapter is not None:
            if isinstance(pretrain_mm_mlp_adapter, str) and os.path.exists(pretrain_mm_mlp_adapter):
        ...
        if mm_projector_weights:
            ...
            print("[INFO] Loaded mm_projector weights.")
        else:
            print("[INFO] No mm_projector weights loaded. Skipping.")
    ...
    def initialize_vision_tokenizer(self, mm_use_im_start_end, tokenizer, device,
        ...
        if mm_use_im_start_end:
            ...
            if pretrain_mm_mlp_adapter:
                mm_projector_weights = None
                if isinstance(pretrain_mm_mlp_adapter, str):
                    mm_projector_weights = torch.load(pretrain_mm_mlp_adapter, map_location='cpu')
